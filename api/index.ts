...
import { createAuthRoutes } from '../dist/modules/auth/auth.route';
import { createJobRoutes } from '../dist/modules/jobs/job.route';
import { createApplicationRoutes } from '../dist/modules/applications/application.route';
import { createSavedJobRoutes } from '../dist/modules/saved-jobs/savedJob.route';
import { createUserRoutes } from '../dist/modules/users/user.route';
import { createRecruiterRoutes } from '../dist/modules/recruiter/recruiter.route';
import { createAdminRoutes } from '../dist/modules/admin/admin.route';
import { createBlogRoutes } from '../dist/modules/blog/blog.route';
import { createAIRoutes } from '../dist/modules/ai/ai.route';
import { createSeekerProfileRoutes } from '../dist/modules/seeker-profile/seekerProfile.route';
import { createRecruiterProfileRoutes } from '../dist/modules/recruiter-profile/recruiterProfile.route';
import { createPaymentRoutes } from '../dist/modules/payments/payment.route';
import { setUserCollection } from '../dist/middlewares/auth.middleware';
import { globalErrorHandler } from '../dist/middlewares/error.middleware';
