...
import { createJobRoutes } from './modules/jobs/job.route.js';
import { createApplicationRoutes } from './modules/applications/application.route.js';
import { createSavedJobRoutes } from './modules/saved-jobs/savedJob.route.js';
import { createUserRoutes } from './modules/users/user.route.js';
import { createRecruiterRoutes } from './modules/recruiter/recruiter.route.js';
import { createAdminRoutes } from './modules/admin/admin.route.js';
import { createBlogRoutes } from './modules/blog/blog.route.js';
import { createAIRoutes } from './modules/ai/ai.route.js';
import { createSeekerProfileRoutes } from './modules/seeker-profile/seekerProfile.route.js';
import { createRecruiterProfileRoutes } from './modules/recruiter-profile/recruiterProfile.route.js';
import { createPaymentRoutes } from './modules/payments/payment.route.js';
import { createDashboardSearchRoutes } from './modules/dashboard-search/dashboardSearch.route.js';
import { Db } from 'mongodb';
import { setUserCollection } from './middlewares/auth.middleware.js';
...
export function createApp(db: Db) {
  ...
  app.use('/api/admin', createAdminRoutes(userCollection, jobCollection, applicationCollection, recruiterRequestCollection, blogCollection, plansCollection, seekerProfileCollection, recruiterProfileCollection));
